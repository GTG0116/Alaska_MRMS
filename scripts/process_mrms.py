...
# --- CONFIGURATION ---
# Full MRMS Alaska domain bounds
LAT_TOP, LAT_BOT = 72.0, 50.0
LON_LEFT, LON_RIGHT = -176.0, -126.0   # Note: Longitudes are negative (West)
...
FLAG_PREFIX = "ALASKA/PrecipFlag_00.00"
...
SINGLE_PRODUCTS = {
    ...
    'qpe6h': {
        'prefix': 'ALASKA/RadarOnly_QPE_06H_00.00',
    ...
    'qpe24h': {
        'prefix': 'ALASKA/RadarOnly_QPE_24H_00.00',
    ...
    'lightning': {
        'prefix': 'ALASKA/LightningProbabilityNext60minGrid_scale_1',
    ...
    'rotation': {
        'prefix': 'ALASKA/MergedAzShear_0-2kmAGL_00.50',
...
def _fetch_hrrr_vars_s3(date_str, hour_str, hours_back):
    ...
    base_url = (
        f"{HRRR_BUCKET}/hrrr.{date_str}/ALASKA"
...
def discover_rate_prefix():
    ...
    url = f"{BUCKET_URL}/?list-type=2&prefix=ALASKA/&delimiter=/"
    try:
        ...
        pass
    return "ALASKA/SurfacePrecipRate_00.00"
